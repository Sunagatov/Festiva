...
public final class Messages {
    ...
    public static final String STATS_FRIENDS          = "stats_friends";
    public static final String STATS_NEXT_NONE        = "stats_next_none";
    public static final String STATS_NEXT_TODAY       = "stats_next_today";
    public static final String STATS_NEXT_IN_DAYS     = "stats_next_in_days";
    public static final String STATS_THIS_MONTH       = "stats_this_month";
    public static final String STATS_JUBILEES         = "stats_jubilees";
    public static final String SETTINGS_HEADER        = "settings_header";
    public static final String SETTINGS_HOUR_SET      = "settings_hour_set";
    public static final String MORE_HEADER            = "more_header";
    public static final String MORE_BTN               = "more_btn";
    public static final String MORE_SEARCH_BTN        = "more_search_btn";
    public static final String MORE_EDIT_BTN          = "more_edit_btn";
    public static final String MORE_REMOVE_BTN        = "more_remove_btn";
    public static final String MORE_JUBILEE_BTN       = "more_jubilee_btn";
    public static final String MORE_BROWSE_BTN        = "more_browse_btn";
    public static final String MORE_STATS_BTN         = "more_stats_btn";
    public static final String MORE_IMPORT_BTN        = "more_import_btn";
    public static final String MORE_EXPORT_BTN        = "more_export_btn";
    ...
    public static final String FRIEND_ADDED_CARD      = "friend_added_card";
    ...
    public static final String UPCOMING_TODAY_LABEL    = "upcoming_today_label";
