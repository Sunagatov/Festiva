...
class BirthdayReminderTest extends IntegrationTestBase {
    ...
    private void savePrefs(long userId) {
        userPreferenceRepository.save(new UserPreference(userId, Lang.EN, 9));
    }
    ...
    void todayBirthday_sendsNotificationWithName() {
        ...
        birthdayReminder.checkBirthdaysForHour(9);
    ...
    void notificationFailure_doesNotPropagateException() {
        ...
        assertThatCode(() -> birthdayReminder.checkBirthdaysForHour(9)).doesNotThrowAnyException();
    }
}
